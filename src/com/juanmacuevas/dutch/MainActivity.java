...
import com.juanmacuevas.dutch.R;
...
public class MainActivity extends ListActivity {
	...
	/**
	 * The collection of all samples in the app. This gets instantiated in
	 * {@link #onCreate(android.os.Bundle)} because the {@link Sample}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mSamples = new Sample[] {
				...
				new Sample(R.string.title_screen_slide,
						ScreenSlideActivity.class),
				new Sample(R.string.title_zoom, ZoomActivity.class),
				new Sample(R.string.title_layout_changes,
						LayoutChangesActivity.class), };

		startActivity(new Intent(MainActivity.this, mSamples[2].activityClass));
		finish();
